...
const TacticalHomePage = () => {
  ...
  // ImageURLPATH="https://img.cgbgear.cn/wpage/btn/wrapper-btn/";
  ...
  useEffect(() => {
    try {
      const seen = window.localStorage.getItem("cgb_cookie_seen");
      if (!seen) setShowCookie(true);
    } catch (e) {
      setShowCookie(true);
    }
  }, []);
  ...
  const handleCookieClose = () => {
    setShowCookie(false);
    try {
      window.localStorage.setItem("cgb_cookie_seen", "1");
    } catch (e) { }
  };
          ...
          <div className="left-column">
            <article className="banner-card">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-forum.PNG_.webp')"
                }}
              />
            ...
            <article className="banner-card">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-product.png_.webp')"
                }}
              />
              <div className="banner-overlay" />
              <div className="banner-content">
            ...
            <article className="banner-card">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-3dgears.jpg_.webp')",
                  backgroundPositionY:
                    "-8.5vh"
                }}
              />
            ...
            <article className="banner-card">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-field-shooting.jpg_.webp')"
                }}
              />
              <div className="banner-overlay" />
              <div className="banner-content">
        ...
        <section className="grid-section">
          <div className="grid-cards">
            ...
            <article
              ...
              style={{
                backgroundImage:
                  "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-notice.jpg_.webp')",
                backgroundPositionY:
                  "-9.5vh"
              }}
            >
              <div className="grid-card-inner">
                ...
                <div className="grid-title-cn">网站公告</div>
                <div className="grid-title-en">
                  Website Announcement / Suggestion
                </div>
                <div className="grid-actions">
                  <button className="grid-btn" onClick={() => navigate('/notice')}>
                    <span>查看</span>
                    <span>VIEW</span>
                  </button>
                </div>
            ...
            <article
              ...
              style={{
                backgroundImage:
                  "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-sign-up.JPG_.webp')",
                backgroundPositionY:
                  "-5.5vh"
              }}
            >
              <div className="grid-card-inner">
                ...
                <div className="grid-title-cn">
                  军推/场地/漫展/外拍招募活动
                </div>
                <div className="grid-title-en">
                  Field Shooting Sign-up Event
                </div>
                <div className="grid-actions">
            ...
            <article
              ...
              style={{
                backgroundImage:
                  "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-prictical-milltary.png_.webp')",
                backgroundPositionY:
                  "-9.5vh"
              }}
            >
              <div className="grid-card-inner">
                ...
                style={{
                  ...
                  Suggestions on Practical Military and Police Equipment
                </div>
                <div className="grid-actions">
                  <button className="grid-btn">
                    <span>发布意见</span>
            ...
            <article
              ...
              style={{
                backgroundImage:
                  "url('https://img.cgbgear.cn/wpage/btn/wrapper-btn/wrapper-speical.JPG_.webp')",
                backgroundPositionY:
                  "-21.5vh"
              }}
            >
              <div className="grid-card-inner">
                ...
                <div className="grid-title-cn">尼龙卫星</div>
                <div className="grid-title-en">
                  Special Plan for R&amp;D of Nylon Tactical Equipment
                </div>
                <div className="grid-actions">
                  <button className="grid-btn">
                    <span>查看</span>
      ...
      {showCookie && (
        <div className="cookie-bar">
          <div className="cookie-inner">
            <div>
              为提供更好的浏览体验，本网站可能会使用 Cookie 及统计工具，
              不会收集敏感隐私信息。
            </div>
